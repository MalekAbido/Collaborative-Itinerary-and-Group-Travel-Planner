...
(
  ...
  pollId         INT           NOT NULL,
  tripMemberId   INT           NOT NULL,
  ratingChoice   VARCHAR(20)   NOT NULL,
  PRIMARY KEY (id)
);
...
-- INSERT INTO Vote (voteId, timestamp, pollId, tripMemberId, ratingChoice) VALUES
...
CREATE TABLE IF NOT EXISTS schema_setup_completed (
    id INT PRIMARY KEY,
    completed_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

INSERT INTO schema_setup_completed (id) VALUES (1);