...
<body
    class="bg-background text-on-background font-body text-body-md min-h-screen flex flex-col m-0 overflow-x-hidden overflow-y-auto">
    <header
        ...
        <div class="text-[22px] font-display font-extrabold text-primary tracking-tight">Itinerary</div>
