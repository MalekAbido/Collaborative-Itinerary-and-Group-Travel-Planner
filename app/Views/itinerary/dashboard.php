        ...
        <div class="mx-auto flex h-full max-w-[1280px] items-center justify-between px-6 lg:px-8">
            <div class="flex items-center gap-8">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="#" class="px-3 py-2 rounded-md text-body-sm font-medium text-on-surface-variant hover:text-primary transition">Finances</a>
                </div>
            </div>
    ...
    <main class="flex-1 mt-navbar h-[calc(100vh-theme(spacing.navbar))] overflow-y-auto bg-surface p-6 lg:p-8 scroll-thin">
        <div class="max-w-[1280px] mx-auto">
            ...
            <header class="mb-10 flex justify-between items-end">
                <div>
                    <span class="inline-flex items-center rounded-full bg-success-container px-3 py-1 text-label-xs font-bold uppercase text-on-success-container mb-3">✓ Active Trip</span>
                    <h1 class="font-display text-display text-on-surface mb-2"><?= htmlspecialchars($data['trip']['title']) ?></h1>
                    <p class="text-body-lg text-on-surface-variant flex items-center gap-2">
                        <span class="material-symbols-outlined text-[20px]">calendar_month</span>
                        <?= htmlspecialchars($data['trip']['startDate']) ?> to <?= htmlspecialchars($data['trip']['endDate']) ?>
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <article class="flex bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm overflow-hidden hover:shadow-md transition mb-4 opacity-50">
                        <div class="flex flex-col items-center justify-center bg-surface-container-highest text-outline px-4 py-5 w-24 shrink-0">
                        ...
                        <div class="flex-1 p-5 flex flex-col justify-center">
                            ...
                            <p class="text-body-sm text-on-surface-variant">Click "Add Activity" above to start building your timeline.</p>
                        </div>
                    </article>
                </div>
